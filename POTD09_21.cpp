...
public:
    Node *copyList(Node *head) {
        ...
        Node* curr = head;
        while (curr) {
            Node* newNode = new Node(curr->data); // Clone node
        ...
        // Step 3: Restore the original list and separate the new list
        curr = head;
        Node* newHead = head->next; // This will be the head of the copied list
        Node* copy = newHead;
